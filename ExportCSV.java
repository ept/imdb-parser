...
// 
// ExportCSV document-database-directory csv-output-directory 
// 
public class  ExportCSV {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (MovieDB database = new MovieDB(new File(document_db_dir))) {
		...
		for (Movie movie : database.getByTitlePrefix("")) {
			...
			for (Entry<String,List<ReleaseDate>> rel : movie.getReleaseDates().entrySet()) {
